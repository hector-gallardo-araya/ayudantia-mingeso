...
--
-- Name: gestion_estudiantes; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE gestion_estudiantes WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Spanish_Spain.1252';


ALTER DATABASE gestion_estudiantes OWNER TO postgres;

\connect gestion_estudiantes
...
ALTER TABLE public.asignatura_id_seq1 OWNER TO postgres;
...
rut1	asdd	\N	\N	asd	23
rut2	gonzalez	1	1	pepito	\N
\.
...
SELECT pg_catalog.setval('public.carrera_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.direccion_id_seq', 1, true);
